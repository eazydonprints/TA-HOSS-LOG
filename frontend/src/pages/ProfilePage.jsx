...
const ProfilePage = () => {
  ...
  /*
  |--------------------------------------------------------------------------
  | Navigation Tab State ("general" | "security" | "account")
  |--------------------------------------------------------------------------
  */
  ...
  */
  const handlePhotoSelect = (event) => {
    ...
    if (file.size > 5 * 1024 * 1024) {
      setErrorMessage("Profile photo must not exceed 5MB.");
      event.target.value = "";
      return;
    }
  ...
  const uploadToCloudinary = async (file) => {
    ...
    formData.append("folder", "ta-hoss/profile-photos");
  ...
  const handleRemovePhoto = async () => {
    ...
    try {
      ...
      setErrorMessage(error.message || "Unable to remove profile photo.");
    } finally {
  ...
  const handleSaveName = async (event) => {
    ...
    if (trimmedName === (user?.fullname || "").trim()) {
      setSuccessMessage("No changes were made to your name.");
      return;
    }
    ...
    try {
      ...
      setSuccessMessage("Your full name has been updated successfully.");
    } catch (error) {
      setErrorMessage(error.message || "Unable to update your full name.");
    } finally {
      setSavingName(false);
    }
  };
  ...
  const handleRefreshProfile = async () => {
    ...
    try {
      ...
      setSuccessMessage("Profile information refreshed.");
    } catch (error) {
  ...
  const displayedPhoto =
    previewUrl || user?.photo || user?.profilePhoto || user?.avatar || null;
    ...
    <div className="profile-page">
      <div className="profile-container">
        ...
        <div className="profile-page-header">
          <div>
            <h1>My Profile</h1>
            <p>Manage your personal information, profile photo and security settings.</p>
          </div>
          <button
            type="button"
        ...
        <div className="profile-nav-tabs">
          <button
            type="button"
            className={`profile-tab-button ${activeTab === "general" ? "active" : ""}`}
            onClick={() => { setActiveTab("general"); clearFeedback(); }}
          >
            Profile Information
          </button>
          <button
            ...
            onClick={() => { setActiveTab("security"); clearFeedback(); }}
          >
            Password & Security
          </button>
          <button
            ...
            onClick={() => { setActiveTab("account"); clearFeedback(); }}
          >
            Account Information
          </button>
        </div>
            ...
            <div className="profile-card-body">
              <div className="profile-photo-section">
                ...
                <div className="profile-photo-actions">
                  ...
                  >
                    {user.photo ? "Replace Photo" : "Upload Photo"}
                  </button>
                ...
                {selectedFile && (
                  <div className="profile-photo-preview-actions">
                    <p>Previewing: <strong>{selectedFile.name}</strong></p>
                    <div>
                      <button
                        type="button"
                        className="profile-button profile-button-primary"
                ...
                <small className="profile-photo-help">JPG, PNG or WebP. Max size: 5MB.</small>
              </div>
              ...
              <div className="profile-details-section">
                <form onSubmit={handleSaveName} className="profile-form">
                  ...
                  <div className="profile-form-group">
                    ...
                    <small>Username cannot be changed from your profile.</small>
                  </div>
                  <button type="submit" className="profile-button profile-button-primary" disabled={savingName}>
        ...
        {activeTab === "security" && (
          <section className="profile-card profile-security-card">
            <div className="profile-card-header">
              ...
              <p>Change your password to keep your TA-HOSS LOG account secure.</p>
            </div>
            <div className="profile-card-body">
              <form onSubmit={handleChangePassword} className="profile-password-form">
                  ...
                  {newPassword && (
                    <div className="password-strength">
                      ...
                      <div className="password-requirements">
                        <span className={passwordStrength.checks.length ? "requirement-met" : ""}>✓ 8+ chars</span>
                        <span className={passwordStrength.checks.uppercase ? "requirement-met" : ""}>✓ Uppercase</span>
                        <span className={passwordStrength.checks.lowercase ? "requirement-met" : ""}>✓ Lowercase</span>
                        <span className={passwordStrength.checks.number ? "requirement-met" : ""}>✓ Number</span>
                        <span className={passwordStrength.checks.special ? "requirement-met" : ""}>✓ Special char</span>
                      </div>
                    </div>
                  )}
                </div>
                ...
                <div className="profile-form-group">
                  ...
                  {confirmPassword && (
                    <small className={newPassword === confirmPassword ? "password-match" : "password-no-match"}>
                      {newPassword === confirmPassword ? "✓ Passwords match" : "Passwords do not match"}
                    </small>
                  )}
                </div>

                <button type="submit" className="profile-button profile-button-primary" disabled={changingPassword}>
        ...
        {activeTab === "account" && (
          <section className="profile-card">
            <div className="profile-card-header">
              ...
              <p>Detailed information and system role associated with your account.</p>
            </div>
            <div className="profile-account-info">
              ...
              <div className="account-info-item">
                ...
                <strong className={accountIsActive ? "text-active" : "text-inactive"}>
      ...
      {showRemoveConfirmation && (
        <div className="profile-modal-backdrop" onClick={() => !removingPhoto && setShowRemoveConfirmation(false)}>
          <div className="profile-confirmation-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="confirmation-actions">
              ...
              <button
                ...
                disabled={removingPhoto}
              >
                {removingPhoto ? "Removing..." : "Yes, Remove Photo"}
              </button>
            </div>
          </div>
        </div>
