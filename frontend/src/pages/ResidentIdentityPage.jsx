...
const ResidentIdentityPage = () => {
  ...
  const [loading, setLoading] =
    useState(true);
  const [generatingQR, setGeneratingQR] =
    useState(false);
  ...
  const loadIdentity = async () => {
    try {
      ...
      if (
        ...
        setError(
          "Resident identity information was not found."
        );
      }
    } catch (err) {
      console.error(
        "RESIDENT IDENTITY ERROR:",
        err
      );
    ...
    return (
      <div className="dashboard-page">
        <div className="empty-state">
          ...
          <span>
            The requested digital identity
            could not be found.
          </span>
        </div>
      </div>
    ...
    <div className="dashboard-page resident-identity-page">
      <div className="dashboard-header">
        <div>
          ...
          <h1>
            Resident Digital Identity
          </h1>

          <p>
            Official TA-HOSS LOG digital
            identity profile.
          </p>
        </div>
        ...
        <section className="dashboard-panel">
          <div className="panel-header">
            <div>
              ...
              <p>
                Household associated with this
                resident identity.
              </p>
            </div>
          </div>
      ...
      <section className="dashboard-panel identity-qr-panel">
        <div className="panel-header">
          <div>
            ...
            <p>
              Secure QR identity used to verify
              this resident.
            </p>
          </div>
        </div>
        ...
        {qr.available ? (
          <div className="qr-identity-summary">
            ...
            <div>
              <strong>
                QR Identity Available
              </strong>

              <p>
                This resident already has an
                active TA-HOSS QR identity.
              </p>
            </div>
          ...
          <div className="qr-empty-state">
            ...
            <div>
              ...
              <p>
                Generate a QR identity for this
                verified resident.
              </p>
            </div>
      ...
      <section className="dashboard-panel">
        <div className="household-action-grid">
          ...
          >
            ...
            <span>
              View resident identification card
            </span>
          </button>
        </div>
      </section>
